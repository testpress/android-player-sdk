...
public interface TpStreamPlayer {
    ...
    fun addTestpressAnalyticsListener(testpressLogger: TestpressLogger)
...
internal class TpStreamPlayerImpl(val context: Context) : TpStreamPlayer {
    ...
    override fun addTestpressAnalyticsListener(testpressLogger: TestpressLogger) {
        exoPlayer.addAnalyticsListener(testpressLogger)
    }
